...
If you would like to discuss the changes you wish to make, join our [Discord community](https://discord.company-local-ai.ai), where you can engage with other contributors and seek guidance from the community.
...
8. Setup and run integration tests:
    ...
    - Copy `company-local-ai.yaml`: `cp company-local-ai.example.yaml company-local-ai.yaml`.
    - Run: `npm run e2e`.
