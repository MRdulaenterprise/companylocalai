...
const { agentSchema } = require('@company-local-ai/data-schemas');
const { MongoMemoryServer } = require('mongodb-memory-server');
const { AccessRoleIds, ResourceType, PrincipalType } = require('company-local-ai-data-provider');
const {
  getAgent,
  loadAgent,
  createAgent,
...
/**
 * @type {import('mongoose').Model<import('@company-local-ai/data-schemas').IAgent>}
 */
let Agent;
...
describe('models/Agent', () => {
  ...
  describe('Agent CRUD Operations', () => {
    ...
    test('should handle ephemeral agent loading', async () => {
      ...
      const originalModule = jest.requireActual('company-local-ai-data-provider');
      ...
      jest.doMock('company-local-ai-data-provider', () => mockDataProvider);

      expect(agentId).toBeDefined();
      expect(endpoint).toBeDefined();

      jest.dontMock('company-local-ai-data-provider');
    });
  ...
  describe('Load Agent Functionality', () => {
    ...
    test('should test ephemeral agent loading logic', async () => {
      const { EPHEMERAL_AGENT_ID } = require('company-local-ai-data-provider').Constants;
