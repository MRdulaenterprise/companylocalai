...
const { sanitizeFilename } = require('@company-local-ai/api');
const { fileConfig: defaultFileConfig, mergeFileConfig } = require('company-local-ai-data-provider');
...
/**
 *
 * @param {import('company-local-ai-data-provider').FileConfig | undefined} customFileConfig
 */
