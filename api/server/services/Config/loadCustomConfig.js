...
const { loadYaml } = require('@company-local-ai/api');
...
const defaultConfigPath = path.resolve(projectRoot, 'company-local-ai.yaml');
...
https://www.company-local-ai.ai/docs/configuration/stt_tts`);
      }
