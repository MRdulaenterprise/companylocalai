...
const { sanitizeFilename, parseText, processAudioFile } = require('@company-local-ai/api');
const {
  convertImage,
  resizeAndConvert,
  resizeImageBuffer,
 ...
 * @param {RunClient} params.client - The Company Local AI client instance: either refers to `openai` or `streamRunManager`.
 * @param {string} params.file_id - The ID of the file to retrieve.
