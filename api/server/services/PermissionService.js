...
const { getTransactionSupport, logger } = require('@company-local-ai/data-schemas');
const { ResourceType, PrincipalType, PrincipalModel } = require('company-local-ai-data-provider');
const {
...
/**
 * @import { TPrincipal } from 'company-local-ai-data-provider'
 */
/**
