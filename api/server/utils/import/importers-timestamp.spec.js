...
describe('Import Timestamp Ordering', () => {
  ...
  describe('Company Local AI Import - Timestamp Issues', () => {
    test('should maintain proper timestamp order between parent and child messages', async () => {
      // Create a Company Local AI export with out-of-order timestamps
      const jsonData = {
    ...
    test('recursive format should NOW have timestamp protection', async () => {
      // Create a recursive Company Local AI export with out-of-order timestamps
      const jsonData = {
