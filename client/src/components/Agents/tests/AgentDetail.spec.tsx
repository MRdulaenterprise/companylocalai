...
import { Constants, EModelEndpoint } from 'company-local-ai-data-provider';
...
jest.mock('@company-local-ai/client', () => ({
  ...jest.requireActual('@company-local-ai/client'),
...
describe('AgentDetail', () => {
  beforeEach(() => {
    ...
    const { useToastContext } = require('@company-local-ai/client');
