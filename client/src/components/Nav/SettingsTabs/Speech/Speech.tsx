...
import { useOnClickOutside, useMediaQuery } from '@company-local-ai/client';
import { useGetCustomConfigSpeechQuery } from 'company-local-ai-data-provider/react-query';
import {
