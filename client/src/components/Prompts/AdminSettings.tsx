...
import { Permissions, SystemRoles, roleDefaults, PermissionTypes } from 'company-local-ai-data-provider';
import {
  OGDialog,
  OGDialogTitle,
  OGDialogContent,
                    ...
                    {selectedRole === SystemRoles.ADMIN && promptPerm === Permissions.USE && (
                      <>
                        <div className="mb-2 max-w-full whitespace-normal break-words text-sm text-red-600">
                          ...
                          {'\n'}
                          <a
                            href="https://www.company-local-ai.ai/docs/configuration/company-local-ai_yaml/object_structure/interface"
                            target="_blank"
                            rel="noreferrer"
