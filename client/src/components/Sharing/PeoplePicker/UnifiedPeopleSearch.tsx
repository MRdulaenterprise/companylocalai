...
import type { TPrincipal, PrincipalType, PrincipalSearchParams } from 'company-local-ai-data-provider';
import { useSearchPrincipalsQuery } from 'company-local-ai-data-provider/react-query';
