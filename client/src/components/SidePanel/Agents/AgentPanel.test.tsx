...
jest.mock('company-local-ai-data-provider', () => {
  const actualModule = jest.requireActual('company-local-ai-data-provider') as any;
  return {
    ...actualModule,
    dataService: {
      updateAgent: jest.fn(),
...
jest.mock('@company-local-ai/client', () => ({
...
jest.mock('company-local-ai-data-provider/react-query', () => ({
...
// Import after mocks
import { dataService } from 'company-local-ai-data-provider';
