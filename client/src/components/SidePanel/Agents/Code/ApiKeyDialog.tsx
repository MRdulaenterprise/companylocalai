import { OGDialogTemplate, Input, Button, OGDialog } from '@company-local-ai/client';
        ...
        main={
          <>
            <div className="mb-4 text-center font-medium">
              {localize('com_ui_company-local-ai_code_api_title')}
            </div>
            <div className="mb-4 text-center text-sm">
              {localize('com_ui_company-local-ai_code_api_subtitle')}
            </div>
            ...
            <div className="mb-6">
              ...
              <a
                href="https://code.company-local-ai.ai/pricing"
                target="_blank"
              ...
              >
                {localize('com_ui_company-local-ai_code_api_key')}
              </a>
            </div>
