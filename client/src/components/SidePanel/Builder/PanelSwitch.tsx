...
import { defaultAssistantsVersion } from 'company-local-ai-data-provider';
import type { Action, TEndpointsConfig, AssistantsEndpoint } from 'company-local-ai-data-provider';
