/* Memories */
import { QueryKeys, MutationKeys, dataService } from 'company-local-ai-data-provider';
...
import type { TUserMemory, MemoriesResponse } from 'company-local-ai-data-provider';
