...
import { EModelEndpoint, AgentCapabilities } from 'company-local-ai-data-provider';
import type { TAgentsEndpoint, TEndpointsConfig } from 'company-local-ai-data-provider';
