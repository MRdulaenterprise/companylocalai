...
(async () => {
  ...
  console.purple('Removing all tags for Company Local AI `deployed` images...');
  const repositories = ['ghcr.io/danny-avila/company-local-ai-dev-api', 'company-local-ai-client'];
  ...
  console.purple('Pulling latest Company Local AI images...');
