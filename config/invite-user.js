...
const { checkEmailConfig } = require('@company-local-ai/api');
const { User } = require('@company-local-ai/data-schemas').createModels(mongoose);
...
(async () => {
  ...
  const appName = process.env.APP_TITLE || 'Company Local AI';
