import { loadDefaultInterface } from '@company-local-ai/data-schemas';
import { SystemRoles, Permissions, PermissionTypes, roleDefaults } from 'company-local-ai-data-provider';
import type { TConfigDefaults, TCustomConfig } from 'company-local-ai-data-provider';
