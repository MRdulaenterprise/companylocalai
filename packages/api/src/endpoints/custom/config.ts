import { EModelEndpoint, extractEnvVariable } from 'company-local-ai-data-provider';
import type { TCustomEndpoints, TEndpoint, TConfig } from 'company-local-ai-data-provider';
