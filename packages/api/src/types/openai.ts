import { z } from 'zod';
import { openAISchema, EModelEndpoint } from 'company-local-ai-data-provider';
import type { TEndpointOption, TAzureConfig, TEndpoint, TConfig } from 'company-local-ai-data-provider';
import type { BindToolsInput } from '@langchain/core/language_models/chat_models';
import type { OpenAIClientOptions, Providers } from '@company-local-ai/agents';
