import { extractCompany Local AIParams } from './llm';

describe('extractCompany Local AIParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractCompany Local AIParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractCompany Local AIParams();
  ...
  it('should extract all Company Local AI params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractCompany Local AIParams(options);
  ...
  it('should handle null values for Company Local AI params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known Company Local AI params', () => {
    const options = {
      resendFiles: false,
    ...
    // Company Local AI params extracted
    expect(result.resendFiles).toBe(false);
  ...
  it('should not mutate the original options object', () => {
    ...
    extractCompany Local AIParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional Company Local AI params', () => {
    const options = {
      resendFiles: false,
