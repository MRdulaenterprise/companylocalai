...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should throw an error if environment variables are set but not configured', () => {
    const validConfigs: TAzureGroups = [
      {
        group: 'company-local-ai-westus',
        apiKey: '${WESTUS_API_KEY}',
        instanceName: 'company-local-ai-westus',
      ...
      {
        group: 'company-local-ai-eastus',
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'company-local-ai-eastus',
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'company-local-ai-westus'
    expect(groupMap).toHaveProperty('company-local-ai-westus');
    expect(groupMap['company-local-ai-westus']).toEqual(
    ...
    // Check groupMap for 'company-local-ai-eastus'
    expect(groupMap).toHaveProperty('company-local-ai-eastus');
    expect(groupMap['company-local-ai-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'company-local-ai-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'company-local-ai-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'company-local-ai-eastus',
