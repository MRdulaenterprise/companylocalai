...
import type { TCustomConfig, TAssistantEndpoint } from 'company-local-ai-data-provider';
...
/**
 * Sets up the Assistants configuration from the config (`company-local-ai.yaml`) file.
