...
import type { TCustomConfig, TAzureConfig } from 'company-local-ai-data-provider';

/**
 * Sets up the Azure OpenAI configuration from the config (`company-local-ai.yaml`) file.
