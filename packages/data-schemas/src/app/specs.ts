...
/**
 * Sets up Model Specs from the config (`company-local-ai.yaml`) file.
...
For more information, see the documentation at https://www.company-local-ai.ai/docs/configuration/company-local-ai_yaml/object_structure/model_specs#endpoint`);
      continue;
    }
